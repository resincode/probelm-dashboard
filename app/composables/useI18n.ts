...
const en: TranslationDictionary = {
  ...
  'workspace.errorLogTitle': 'Probe error log & diagnostics',
  'workspace.lastRunDuration': 'Execution time',
  'workspace.lastRunStatus': 'Last run status',
  ...
  'workspace.providerComparisonEyebrow': 'PROVIDER COMPARISON',
  'workspace.providerComparisonTitle': 'One chart, all selected providers',
  'workspace.providerComparisonHint': 'Use the chips to show or hide a provider line.',
  'workspace.statusTimelineEyebrow': 'STATUS TIMELINE',
  'workspace.statusTimelineTitle': 'Provider status over time',
  'workspace.ttft': 'TTFT',
...
const id: TranslationDictionary = {
  ...
  'workspace.providerComparisonEyebrow': 'PERBANDINGAN PROVIDER',
  'workspace.providerComparisonTitle': 'Satu grafik, semua provider terpilih',
  'workspace.providerComparisonHint': 'Gunakan chip untuk menampilkan atau menyembunyikan garis provider.',
  'workspace.statusTimelineEyebrow': 'TIMELINE STATUS',
  'workspace.statusTimelineTitle': 'Status provider dari waktu ke waktu',
  'workspace.ttft': 'TTFT',
